...
> = ({ serverBreakpoint }) => {
  ...
  return (
    <>
      {/*TODO*/}
      <Head>
        <title>{locale.title.contacts.title}</title>
        <meta name="description" content={locale.description.contacts.title} />
      ...
      <BreakpointContext.Provider value={breakpoint}>
        <Layout>
          <div className={styles.main}>
            ...
            <h1>{locale.menu[3].title}</h1>
          </div>
          <div className={styles.content}>
            <iframe
              src="https://yandex.ru/map-widget/v1/?um=constructor%3A74459218602129f1f5d57a04e8330386b32edf1cfdd2f5ff2f0080d1570c43f0&amp;source=constructor"
              width="100%"
              height="500"
            ></iframe>
            <div>
              <h1>{locale.address.text.title}</h1>
              <p>{locale.address.main.title}</p>
              <div>
